...
namespace uFR
{
 ...
 DL_IMEI_UID					= 0x80
    ...
    public static class uFCoder
    {
        ...
        [DllImport(DLL_NAME, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Auto, EntryPoint = "write_ndef_record")]
        private static extern DL_STATUS write_ndef_record(byte message_nr, [In] byte[] tnf, [In] byte[] type_record, [In] byte[] type_length, [In] byte[] id, [In] byte[] id_length, [In] byte[] payload, [In] UInt32[] payload_length, out byte[] card_formated);

        [DllImport(DLL_NAME, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Auto, EntryPoint = "write_ndef_record_mirroring")]
        private static extern DL_STATUS write_ndef_record_mirroring(byte message_nr, [In] byte[] tnf, [In] byte[] type_record, [In] byte[] type_length, [In] byte[] id, [In] byte[] id_length, [In] byte[] payload, [In] UInt32[] payload_length, out byte[] card_formated, int use_uid_ascii_mirror, int use_counter_ascii_mirror, UInt32 payload_mirroring_pos);

        [DllImport(DLL_NAME, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Auto, EntryPoint = "write_ndef_recordM")]
        private static extern DL_STATUS write_ndef_recordM(UFR_HANDLE hndUFR, byte message_nr, [In] byte[] tnf, [In] byte[] type_record, [In] byte[] type_length, [In] byte[] id, [In] byte[] id_length, [In] byte[] payload, [In] UInt32[] payload_length, out byte[] card_formated);

        [DllImport(DLL_NAME, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Auto, EntryPoint = "write_ndef_record_mirroringM")]
        private static extern DL_STATUS write_ndef_record_mirroringM(UFR_HANDLE hndUFR, byte message_nr, [In] byte[] tnf, [In] byte[] type_record, [In] byte[] type_length, [In] byte[] id, [In] byte[] id_length, [In] byte[] payload, [In] UInt32[] payload_length, out byte[] card_formated, int use_uid_ascii_mirror, int use_counter_ascii_mirror, UInt32 payload_mirroring_pos);
